...
const HeroSection = () => {
  ...
  return (
    <section className="relative w-full min-h-[450px] md:h-[613px] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 md:px-8 ">
        ...
        <h1
          className="text-white font-bold md:leading-[50px]
          text-3xl sm:text-4xl md:text-[53px]" data-aos="fade-down"
        >
        ...
        <p
          className="text-white/90 mt-4 font-light mx-auto
          text-base sm:text-lg md:text-[18px] max-w-2xl" data-aos="fade-up"
        >
  ...
  hover:bg-transparent hover:border hover:border-primaryBlue"
          ...
          <button
            ...
            className="bg-transparent text-white px-10 sm:px-12 py-3 
            rounded-full text-base sm:text-lg font-normal
            border border-primaryBlue 
            transition-all duration-300 
            hover:bg-[#007BFFFC] hover:border-transparent" data-aos="fade-left"
          >
            Contact Us
          </button>
        </div>
